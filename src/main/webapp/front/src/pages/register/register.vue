<template>
	...
	<div class="container" :style='{"minHeight":"100vh","alignItems":"center","backgroundImage":"url(http://codegen.caihongy.cn/20221024/23b37078fa41495b866fda764fd3ea28.png)","display":"flex","width":"100%","backgroundSize":"100% 100%","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
        <el-form class='rgs-form' v-if="pageFlag=='security1'" :style='{"padding":"20px","borderRadius":"10px","left":"565px","background":"#fff","width":"750px","position":"absolute","height":"auto"}' ref="registerForm" :model="registerForm" :rules="rules">
			<div v-if="true" :style='{"width":"100%","margin":"30px 0 20px 0","lineHeight":"44px","fontSize":"36px","color":"#000","textAlign":"center"}'>找回密码</p></div>
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' prop="username">
			...
			<el-button :style='{"border":"none","cursor":"pointer","padding":"0 10px","margin":"20px auto 5px","outline":"none","color":"#fff","borderRadius":"8px","background":"rgba(0, 0, 0, 1)","display":"block","width":"80%","fontSize":"16px","height":"40px"}' type="primary" @click="getSecurity('registerForm')">下一步</el-button>
        ...
        <el-form class='rgs-form' v-if="pageFlag=='security2'" :style='{"padding":"20px","borderRadius":"10px","left":"565px","background":"#fff","width":"750px","position":"absolute","height":"auto"}' ref="registerForm" :model="registerForm" :rules="rules">
			<div v-if="true" :style='{"width":"100%","margin":"30px 0 20px 0","lineHeight":"44px","fontSize":"36px","color":"#000","textAlign":"center"}'>找回密码</p></div>
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' prop="pquestion">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' prop="myanswer">
			...
			<el-button :style='{"border":"none","cursor":"pointer","padding":"0 10px","margin":"20px auto 5px","outline":"none","color":"#fff","borderRadius":"8px","background":"rgba(0, 0, 0, 1)","display":"block","width":"80%","fontSize":"16px","height":"40px"}' type="primary" @click="validateSecurity('registerForm')">下一步</el-button>
			<router-link :style='{"cursor":"pointer","padding":"0 10%","color":"rgba(40, 40, 40, 1)","display":"inline-block","lineHeight":"1.5","fontSize":"12px","textDecoration":"none"}' to="/login">已有账户登录</router-link>
        </el-form>
        
        <el-form class='rgs-form' v-if="pageFlag=='security3'" :style='{"padding":"20px","borderRadius":"10px","left":"565px","background":"#fff","width":"750px","position":"absolute","height":"auto"}' ref="registerForm" :model="registerForm" :rules="rules">
			<div v-if="true" :style='{"width":"100%","margin":"30px 0 20px 0","lineHeight":"44px","fontSize":"36px","color":"#000","textAlign":"center"}'>找回密码</p></div>
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' prop="newpassword">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' prop="repassword">
			...
			<el-button :style='{"border":"none","cursor":"pointer","padding":"0 10px","margin":"20px auto 5px","outline":"none","color":"#fff","borderRadius":"8px","background":"rgba(0, 0, 0, 1)","display":"block","width":"80%","fontSize":"16px","height":"40px"}' type="primary" @click="updatePassword('registerForm')">修改密码</el-button>
			<router-link :style='{"cursor":"pointer","padding":"0 10%","color":"rgba(40, 40, 40, 1)","display":"inline-block","lineHeight":"1.5","fontSize":"12px","textDecoration":"none"}' to="/login">已有账户登录</router-link>
        </el-form>
		<el-form class='rgs-form' v-if="pageFlag=='register'" :style='{"padding":"20px","borderRadius":"10px","left":"565px","background":"#fff","width":"750px","position":"absolute","height":"auto"}' ref="registerForm" :model="registerForm" :rules="rules">
			...
			<div v-if="true" :style='{"width":"100%","margin":"30px 0 20px 0","lineHeight":"44px","fontSize":"36px","color":"#000","textAlign":"center"}'>南阳特产销售平台注册</p></div>
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='yonghu'" prop="pquestion">
				<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}'>密保问题：</div>
				<el-input v-model="registerForm.pquestion"  placeholder="请输入密保问题" />
			</el-form-item>
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='yonghu'" prop="panswer">
				<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}'>密保答案：</div>
				<el-input v-model="registerForm.panswer"  placeholder="请输入密保答案" />
			</el-form-item>
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='shangjia'" prop="dianpubianhao">
				<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}'>店铺编号：</div>
				<el-input v-model="registerForm.dianpubianhao"  placeholder="请输入店铺编号" />
			</el-form-item>
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='shangjia'" prop="dianpumingcheng">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='shangjia'" prop="dianpudizhi">
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='shangjia'" prop="yingyeshijian">
				<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}'>营业时间：</div>
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='shangjia'" prop="dianputupian">
				<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}'>店铺图片：</div>
                <file-upload
					tip="点击上传店铺图片"
					action="file/upload"
					:limit="1"
			...
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='shangjia'" prop="pquestion">
				<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}'>密保问题：</div>
				<el-input v-model="registerForm.pquestion"  placeholder="请输入密保问题" />
			</el-form-item>
			<el-form-item :style='{"width":"80%","margin":"0 auto 24px"}' v-if="tableName=='shangjia'" prop="panswer">
				<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}'>密保答案：</div>
				<el-input v-model="registerForm.panswer"  placeholder="请输入密保答案" />
			</el-form-item>
...
export default {
    ...
    created() {
      ...
      if ('shangjia' == this.tableName) {
        this.rules.dianpubianhao = [{ required: true, message: '请输入店铺编号', trigger: 'blur' }];
      }
      if ('shangjia' == this.tableName) {
        this.rules.mima = [{ required: true, message: '请输入密码', trigger: 'blur' }];
      }
    ...
    methods: {
      ...
      shangjiadianputupianUploadChange(fileUrls) {
          this.registerForm.dianputupian = fileUrls.replace(new RegExp(this.$config.baseUrl,"g"),"");
      },
