    ...
    <el-tabs tab-position="left" :style='{"border":"2px solid #a4d9b7","padding":"20px","margin":"20px 0 0 0","borderRadius":"8px","background":"rgba(255,255,255,1)"}' @tab-click="handleClick">
      <el-tab-pane label="个人中心">
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="80px">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 4px","background":"none"}' v-if="userTableName=='yonghu'" label="密保问题" prop="pquestion">
            <el-input v-model="sessionForm.pquestion" placeholder="密保问题" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 4px","background":"none"}' v-if="userTableName=='yonghu'" label="密保答案" prop="panswer">
            <el-input v-model="sessionForm.panswer" placeholder="密保答案" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 4px","background":"none"}' v-if="userTableName=='shangjia'" label="店铺编号" prop="dianpubianhao">
            <el-input v-model="sessionForm.dianpubianhao" placeholder="店铺编号" readonly></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 4px","background":"none"}' v-if="userTableName=='shangjia'" label="密码" prop="mima">
            <el-input type="password" v-model="sessionForm.mima" placeholder="密码"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 4px","background":"none"}' v-if="userTableName=='shangjia'" label="店铺名称" prop="dianpumingcheng">
            <el-input v-model="sessionForm.dianpumingcheng" placeholder="店铺名称" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 4px","background":"none"}' v-if="userTableName=='shangjia'" label="店铺地址" prop="dianpudizhi">
            <el-input v-model="sessionForm.dianpudizhi" placeholder="店铺地址" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 4px","background":"none"}' v-if="userTableName=='shangjia'" label="营业时间" prop="yingyeshijian">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 4px","background":"none"}' v-if="userTableName=='shangjia'" label="店铺图片">
            <el-upload
              class="avatar-uploader"
              :action="uploadUrl"
              :headers="headers"
              :show-file-list="false"
              :on-success="shangjiadianputupianHandleAvatarSuccess">
              <img :style='{"border":"1px solid #9ce0b5","cursor":"pointer","minHeight":"100px","boxShadow":"inset 0px 0px 48px 0px #cef1db","color":"#3db769","borderRadius":"6px","textAlign":"center","width":"150px","fontSize":"32px","lineHeight":"100px","height":"auto"}' v-if="sessionForm.dianputupian" :src="baseUrl + sessionForm.dianputupian" class="avatar">
              <i v-else class="el-icon-plus avatar-uploader-icon"></i>
            </el-upload>
          </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 4px","background":"none"}' v-if="userTableName=='shangjia'" label="密保问题" prop="pquestion">
            <el-input v-model="sessionForm.pquestion" placeholder="密保问题" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 4px","background":"none"}' v-if="userTableName=='shangjia'" label="密保答案" prop="panswer">
            <el-input v-model="sessionForm.panswer" placeholder="密保答案" ></el-input>
          </el-form-item>
  ...
  export default {
    ...
    created() {
      ...
      if ('shangjia' == this.userTableName) {
        this.$set(this.sessionForm, 'dianpubianhao', null);
      }
      if ('shangjia' == this.userTableName) {
        this.$set(this.sessionForm, 'mima', null);
      }
      ...
      if ('shangjia' == this.userTableName) {
        this.$set(this.rules, 'dianpubianhao', [{ required: true, message: '请输入店铺编号', trigger: 'blur' }]);
      }
      if ('shangjia' == this.userTableName) {
        this.$set(this.rules, 'mima', [{ required: true, message: '请输入密码', trigger: 'blur' }]);
      }
    ...
    methods: {
      ...
      shangjiadianputupianHandleAvatarSuccess(res, file) {
        if (res.code == 0) {
          if ('shangjia' == this.userTableName) {
            this.sessionForm.dianputupian = 'upload/' + res.file;
          }
        }
      },
      chongzhi() {
