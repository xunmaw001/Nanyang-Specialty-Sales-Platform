<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="特产名称" prop="techanmingcheng">
					<el-input v-model="ruleForm.techanmingcheng" placeholder="特产名称" clearable  :readonly="ro.techanmingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="特产名称" prop="techanmingcheng">
					<el-input v-model="ruleForm.techanmingcheng" placeholder="特产名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="特产类型" prop="techanleixing">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="特产类型" prop="techanleixing">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.techantupian" label="特产图片" prop="techantupian">
					<file-upload
						tip="点击上传特产图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.techantupian" label="特产图片" prop="techantupian">
					...
					<img v-else class="upload-img" style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.techantupian.split(',')" :src="$base.url+item" width="100" height="100">
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="店铺编号" prop="dianpubianhao">
					<el-input v-model="ruleForm.dianpubianhao" placeholder="店铺编号" clearable  :readonly="ro.dianpubianhao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="店铺编号" prop="dianpubianhao">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="特产介绍" prop="techanjieshao">
					<editor 
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.techanjieshao" label="特产介绍" prop="techanjieshao">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.techanjieshao"></span>
                </el-form-item>
...
export default {
		...
		init(id,type) {
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					var json = data.data;
					if(((json.dianpubianhao!=''&&json.dianpubianhao) || json.dianpubianhao==0) && this.$storage.get("role")!="管理员"){
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.techanjieshao = this.ruleForm.techanjieshao.replace(reg,'../../../ssm50kf2/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
