	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template v-show="logistics">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="商户名称" prop="dianpubianhao">
					<el-input v-model="ruleForm.dianpubianhao" placeholder="商户名称" clearable  :readonly="ro.dianpubianhao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="商户名称" prop="dianpubianhao">
					<el-input v-model="ruleForm.dianpubianhao" placeholder="商户名称" readonly></el-input>
				</el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.logistics = this.ruleForm.logistics.replace(reg,'../../../ssm50kf2/upload');
        } else {
