<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="特产类型" prop="techanleixing">
					<el-input v-model="ruleForm.techanleixing" placeholder="特产类型" clearable  :readonly="ro.techanleixing"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="特产类型" prop="techanleixing">
					<el-input v-model="ruleForm.techanleixing" placeholder="特产类型" readonly></el-input>
				</el-form-item>
			</template>
