...
public class ShangjiaController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		ShangjiaEntity u = shangjiaService.selectOne(new EntityWrapper<ShangjiaEntity>().eq("dianpubianhao", username));
    ...
    public R register(@RequestBody ShangjiaEntity shangjia){
    	...
    	ShangjiaEntity u = shangjiaService.selectOne(new EntityWrapper<ShangjiaEntity>().eq("dianpubianhao", shangjia.getDianpubianhao()));
		if(u!=null) {
    ...
    public R security(@RequestParam String username){
        ShangjiaEntity shangjia = shangjiaService.selectOne(new EntityWrapper<ShangjiaEntity>().eq("dianpubianhao", username));
        return R.ok().put("data", shangjia);
    }
